...
const EXERCISES = {
  ...
  shoulderPress: { label: "Shoulder press (elbow angle)", points: [23, 11, 15] }, // hip-shoulder-wrist
  pushUp: { label: "Push-up (elbow angle)", points: [11, 13, 15] }, // shoulder-elbow-wrist
  deadlift: { label: "Deadlift (hip angle)", points: [11, 23, 25] }, // shoulder-hip-knee
};
